...
Direct, selective, optimistic, and operationally serious. The brand should feel like a capable software cofounder—not an app agency, influencer-management company, or “AI builds anything” service.

## Anti-references

Avoid generic SaaS layouts, venture-capital theater, vague “turn followers into revenue” claims, guaranteed outcomes, fake portfolio metrics, excessive copy, and language that makes rapid coding sound like the moat.
...
6. Keep team credibility subtle: small LinkedIn links near the primary pitch, not a prominent résumé section.

## Accessibility & Inclusion

Aim for WCAG AA contrast, keyboard-visible focus states, readable mobile type, semantic forms, and reduced-motion support. Avoid relying on color alone to communicate meaning.
